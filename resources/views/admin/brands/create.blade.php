    ...
    <form class="form-horizontal" method="post" action="{{route('brands.store')}}">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" class="form-control" id="inputEmail3" placeholder="عنوان برند را وارد کنید ">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description" id="" class="form-control" cols="30" placeholder="توضیحات برند را وارد کنید" rows="10"></textarea>
                </div>
            </div>
